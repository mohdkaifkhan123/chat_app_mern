...
1. Clone this repo
2. Go to the client folder using the terminal and install dependencies using npm i and do npm start and for the server go to the parent folder and perform npm i and do npm start and for to connect to MongoDB 
   database I use Mongodb compass
